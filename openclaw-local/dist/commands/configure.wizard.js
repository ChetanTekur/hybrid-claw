...
import { promptLocalModelsConfig } from "./configure.local-models.js";
import { promptIdentityConfig } from "./configure.identity.js";
...
export async function runConfigureWizard(opts, runtime = defaultRuntime) {
    try {
        ...
        if (opts.sections) {
            ...
            if (selected.includes("local-models")) {
