import { providersAddCommand, providersListCommand, providersLogsCommand, providersRemoveCommand, providersStatusCommand, } from "../commands/providers.js";
...
const optionNamesRemove = ["provider", "account", "delete"];
const providerNames = listChatProviders()
    .map((meta) => meta.id)
    .join("|");
export function registerProvidersCli(program) {
