...
import { createHybridRouterWrapper } from "../../hybrid-router.js";
...
export async function runEmbeddedAttempt(params) {
    ...
    try {
        ...
        try {
            ...
            // Hybrid router: intercept streamFn to route between local / cloud models.
            const hybridRouter = createHybridRouterWrapper({
                cfg: params.config,
                agentDir,
                provider: params.provider,
                modelId: params.modelId,
            ...
            if (hybridRouter) {
                activeSession.agent.streamFn = hybridRouter.wrapStreamFn(activeSession.agent.streamFn);
            }
